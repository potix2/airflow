...
class GcpBodyFieldValidator(LoggingMixin):
    ...
    def validate(self, body_to_validate: dict) -> None:
        ...
        Raises ValidationSpecificationException or ValidationFieldException in case of problems with
        specification or the body not conforming to the specification respectively.
