...
class PodRuntimeInfoEnv(K8SModel):
    """Define Pod runtime information as environment variable."""

    def __init__(self, name, field_path):
        """
        Add Kubernetes pod runtime information as environment variables such as namespace, pod IP, pod name.
    ...
    def to_k8s_client_obj(self) -> k8s.V1EnvVar:
        """
        Convert pod runtime information to environment variable.
